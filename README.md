...
In particular, you may need to adjust column names to match your Apscale output files.
...
/Scripts        # store the R scripts here
...
- If anything is unclear or you encounter issues / bugs, please let me know
